...
"""Load public configuration from template or py file and convert dictionary types to objects."""
...
class Config(dict):
    ...
    Config class can parse arguments from a config file of template, json or pyscript.
    ...
    def __init__(self, *args, **kwargs):
        ...
        for arg in args:
            if isinstance(arg, str):
                if arg.endswith('.template') or arg.endswith('.yml'):
                    with open(arg) as f:
                    ...
                    raise Exception('config file must be template or py')
